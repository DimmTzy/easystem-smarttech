    ...
    <div class="d-flex">
        ...
        <aside class="admin-sidebar p-3" style="width:260px;flex-shrink:0;">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link <?php echo e(request()->routeIs('admin.developer') ? 'active' : ''); ?>" href="<?php echo e(route('admin.developer')); ?>">
...
<?php /**PATH D:\School\SERKOM\EASYSTEM SMART TECH\resources\views/layouts/admin.blade.php ENDPATH**/ ?>