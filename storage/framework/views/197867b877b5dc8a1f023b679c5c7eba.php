<footer class="footer-easystem pt-5 pb-4 mt-5">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-2">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2"><a href="<?php echo e(route('products.index')); ?>">Produk</a></li>
        ...
        <p class="text-center small mb-0">&copy; <?php echo e(now()->year); ?> Dimas XII RPL 1. Seluruh hak cipta dilindungi.</p>
    </div>
</footer>
<?php /**PATH C:\Users\Thinkpad\Downloads\SERKOM\EASYSTEM SMART TECH\resources\views/components/footer.blade.php ENDPATH**/ ?>