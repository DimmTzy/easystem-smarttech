        ...
        <div class="card card-modern p-5 fade-in-up" style="max-width:420px;width:100%;">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.store')); ?>">
                ...
                <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label small" for="remember">Ingat saya (tetap login di perangkat ini)</label>
                </div>
...
</html><?php /**PATH C:\Users\Thinkpad\Downloads\SERKOM\EASYSTEM SMART TECH\resources\views/auth/login.blade.php ENDPATH**/ ?>