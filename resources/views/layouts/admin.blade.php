...
<head>
    ...
    <title>@yield('title', 'Dashboard') | Admin Easystem Smart Tech</title>
    ...
    <div class="d-flex">
        ...
        <aside class="admin-sidebar p-3" style="width:260px;flex-shrink:0;">
            <div class="text-center mb-4 mt-2">
                <img src="{{ asset('images/logo3-easystem.png') }}" class="logo-admin"> <br>
            ...
            <li class="nav-item mb-1">
                <a class="nav-link {{ request()->routeIs('admin.developer') ? 'active' : '' }}" href="{{ route('admin.developer') }}">
                    <i class="bi bi-person-badge me-2"></i> Profil Pembuat
                </a>
            </li>
            <ul class="nav nav-pills flex-column">
                <li class="nav-item mb-1">
                ...
                <li class="nav-item mt-4">
                    {{-- Kembali ke website publik TANPA logout — sesi admin tetap aktif --}}
        ...
        <main class="flex-grow-1 p-4">
            <nav class="navbar navbar-light bg-white rounded-3 shadow-sm px-3 mb-4">
                <span class="navbar-brand mb-0 h5 text-primary">@yield('title', 'Dashboard')</span>
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('home') }}" rel="noopener" class="small text-secondary text-decoration-none">
